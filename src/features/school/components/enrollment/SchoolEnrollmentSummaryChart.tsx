...
interface SchoolEnrollmentSummaryChartProps {
...
const SchoolEnrollmentSummaryChart: React.FC<SchoolEnrollmentSummaryChartProps> = ({
  currentEnrollment,
  projectedEnrollment,
  endYear,
  futureYear
  ...
  const chartData = useMemo(() => {
    ...
    // Add Kindergarten if supported
    if (supportedGrades.includes(GRADE_IDS.KINDERGARTEN)) {
      data.push({
        grade: 'K',
    ...
    return data;
  }, [currentEnrollment, projectedEnrollment, supportedGrades]);
...
export default SchoolEnrollmentSummaryChart; 