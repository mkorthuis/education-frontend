...
import { Box, FormControl, InputLabel, Select, MenuItem, SelectChangeEvent, Typography, useTheme, useMediaQuery, Tooltip as MuiTooltip } from '@mui/material';
...
type MetricType = 'graduate' | 'earned_hiset' | 'dropped_out';
...
const GraduationRateChart: React.FC<GraduationRateChartProps> = ({ className }) => {
  ...
  const chartData = districtData.map(districtItem => {
    ...
    return {
      ...
      district: Number(districtPercentage.toFixed(1)),
