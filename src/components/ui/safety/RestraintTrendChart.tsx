...
export interface RestraintData {
  year: number;
  generated: number;
...
export interface RestraintTrendChartProps {
  entityName: string;
  isDistrict: boolean;
  entityRestraintData: RestraintData[];
  stateRestraintData: RestraintData[];
...
const RestraintTrendChart: React.FC<RestraintTrendChartProps> = ({ 
  entityName,
  isDistrict,
  entityRestraintData,
  stateRestraintData,
  ...
  const chartData = useMemo<ChartDataPoint[]>(() => {
    if (!entityRestraintData || !stateRestraintData || !entityEnrollmentData || !stateEnrollmentData) return [];
    
    // Sort the data by year in ascending order
    const sortedEntityData = [...entityRestraintData].sort((a, b) => a.year - b.year);
  ...
  }, [entityRestraintData, stateRestraintData, entityEnrollmentData, stateEnrollmentData, calculatePer100Students]);
